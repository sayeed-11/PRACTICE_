export const info = {
  title: "Jordan MVP",
  type: "Men's Oversized French Terry Pullover Hoodie",
  price: 3607,
  brand : "nike",
  size: ["S", "M", "L", "XL"],
  description:
    "Lightweight and versatile, this baggy French terry hoodie is ready for whatever you have planned. Crackle print graphics add vintage-inspired style while helping you rep the greatest to ever do it.",
  color: "Black/Light Smoke Grey",
  ratings: {
    total_ratings: 100,
    rating_types: {
      1: 5,
