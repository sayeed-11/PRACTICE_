export const info = {
  title: "Jordan Rare Air",
  type: "Men's Fleece Pullover Hoodie",
  price: 8995,
  brand : "nike",
  size: ["XS", "S", "M", "L", "XL", "XXL"],
  description:
    "Celebrate the differences that make us unique with Jordan's Rare Air Collection. Made from breathable heavyweight French terry, this easy-fitting hoodie pairs an all-over wash with a crackle graphic for that perfectly distressed and worn-in look.",
  color: "Deep Royal",
  ratings: {
    total_ratings: 100,
    rating_types: {
