export const info = {
  title: "Air Jordan Wordmark",
  type: "Men's Tokyo Fleece Pullover Hoodie",
  price: 5995,
  brand : "nike",
  size: ["S", "M", "L", "XL",],
  description:
    "Elevate your casual game with Air Jordan. Smooth on the outside with unbrushed loops on the inside, this heavyweight French terry hoodie offers breathable warmth with a premium look and feel. Plus, its vibrant colour nods to Tokyo's legendary pink cherry blossoms.",
  color: " Aster Pink",
  ratings: {
    total_ratings: 100,
    rating_types: {
