 export const info = {
  ...
  size: ["S", "M", "L", "XL"],
  description:
    "Looking for a little extra warmth? Grab this classic hoodie. Smooth on the outside with unbrushed loops on the inside, our midweight French terry is comfortable and breathable enough to wear all year long.",
  color: "Carbon Heather/White",
  ratings: {
    total_ratings: 100,
    rating_types: {
      1: 5,
