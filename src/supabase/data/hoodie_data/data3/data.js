export const info = {
  ...
  type: "Men's French Terry Full-Zip Hoodie",
  brand : "nike",
  price: 4295,
  size: ["S", "M", "L", "XL", "2XL"],
  description:
    "This classic zip-up hoodie is made from French terry fabric to create a soft, versatile wardrobe staple. The standard fit is designed to feel relaxed through the body for easy layering.",
  color: "White/White",
  ratings: {
    total_ratings: 100,
    rating_types: {
